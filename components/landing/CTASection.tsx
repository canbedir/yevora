  ...
  return (
    <section id="workflow" className="relative overflow-hidden border-t border-border/70 py-24">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6">
        <div className="overflow-hidden rounded-[2.5rem] border border-border/70 bg-[linear-gradient(145deg,rgba(255,255,255,0.96),rgba(245,240,231,0.92))] p-8 shadow-[0_36px_120px_-70px_rgba(15,23,42,0.6)] md:p-10">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <Button
              asChild
              size="lg"
              className="h-13 rounded-full px-7 shadow-[0_18px_40px_-18px_var(--color-primary)]"
            >
              <Link href={href}>
                {label}
